...
return [
	...
	"ex: 30 " => "Ex: 30 ",
	"ex: 120" => "Ex: 120",
	"category_wise_product_list_priority_setup_updated_successfully" => "Category wise product list priority setup updated successfully",
	...
	"ضمان المنتجات" => "ضمان المنتجات",
	"سياسة الإرجاع خلال 7 أيام" => "سياسة الإرجاع خلال 7 أيام",
	"الدفع الآمن" => "الدفع الآمن",
	"Pakistan" => "Pakistan",
	"Egypt" => "Egypt",
	...
	"توصيل سريع في الداخل وفي الخارج" => "توصيل سريع في الداخل وفي الخارج",
